  ...
  return (
    <section id="reviews" className="max-w-5xl mx-auto px-6 py-16">
      <div className="text-center mb-12">
        <p className="text-xs font-semibold text-teal-600 uppercase tracking-widest mb-3">Отзывы пациентов</p>
        <h3 className="text-3xl font-bold text-slate-900">Что говорят пациенты</h3>
      </div>
