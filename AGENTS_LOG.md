...
## 2026-07-29 | Kimi | Интеграция GigaChat API — завершено
...
3. Создан scripts/test-gigachat.js
4. Найден и исправлен баг: Sber выдаёт Client Secret в base64, ID/Secret перепутаны в Basic Auth
5. Деплой на Vercel, проверка на проде
6. Первая тестовая генерация статьи: "Мигрень и магний" — успешно

**Следующий шаг:**
- Подключение PubMed API для автоматического поиска научных статей
- Создание Telegram-канала @guryanova_neuro
